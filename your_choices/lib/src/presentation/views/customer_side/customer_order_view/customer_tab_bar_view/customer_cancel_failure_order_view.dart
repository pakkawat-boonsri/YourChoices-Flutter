...
class CustomerCancelFailureOrderView extends StatefulWidget {
  final String uid;
  const CustomerCancelFailureOrderView({
    Key? key,
    required this.uid,
  }) : super(key: key);

  @override
  State<CustomerCancelFailureOrderView> createState() => _CustomerCancelFailureOrderViewState();
}
                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const CustomText(
                          text: "คุณยังไม่มีรายการออเดอร์ที่ยกเลิก/ผิดพลาด",
                          color: Colors.grey,
                          fontSize: 18,
