...
class DoneOrderView extends StatefulWidget {
  ...
  @override
  State<DoneOrderView> createState() => _DoneOrderViewState();
}

class _DoneOrderViewState extends State<DoneOrderView> {
  @override
                      ...
                      child: ListTile(
                        ...
                        subtitle: Row(
                          children: [
                            ...
                            CustomText(
                              text: orderEntity.orderTypes == OrderTypes.completed.toString() ? "อาหารพร้อมรับ" : "",
                              color: Colors.green,
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
                            ),
          ...
          : SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "คุณยังไม่มีรายการออเดอร์ที่เสร็จสิ้น\nพร้อมจัดเก็บเข้าประวัติ",
